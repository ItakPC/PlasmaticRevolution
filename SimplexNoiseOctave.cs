...
namespace Plasma_Rev
{
    public class SimplexNoiseOctave
    {
        ...
        private short perm[512] = new short[512];
        private short permMod12[512] = new short[512];
        ...
        public SimplexNoiseOctave(int seed)
        {
            ...
            {
                int from = random.Next(p.Length);
                int to = random.Next(p.Length);
        ...
        {
            double s = (xin + yin) * F2;
            int i = MathHelper.fastFloor(xin + s);
            int j = MathHelper.fastFloor(yin + s);
            double t = (i + j) * G2;
            double X0 = i - t;
            double Y0 = j - t;
            double x0 = xin - X0;
